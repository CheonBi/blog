...
const title = SiteConfig.subtitle.split(titleSeperator)
const titleIndex = title.findIndex((t) => t.length > 0)
      ...
      <div className="home-hero-inner">
        <div className="hero-main">
          ...
          <h1 ref={titleRef} className="hero-title">
            <span className="ln">{title[titleIndex]}.</span>
            <span className="ln">
              <span className="accent">{title[titleIndex + 1]}</span>
